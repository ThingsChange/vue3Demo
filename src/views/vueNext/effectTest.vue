...
export default {
    ...
    setup() {
        ...
        effect(
            ...
            },
            {
                ...
                onTrack({ effect, target, type, key }) {
                    console.log(
                        '这里是 effect,target,type,key 的结果------track-------',
                        typeof effect,
                        target,
                        type,
                        key
                ...
                onTrigger({ effect, target, type, key }) {
                    console.log(
                        '这里是 effect,target,type,key 的结果---trigger----------',
                        effect,
                        target,
                        type,
                        key
        ...
        let unWatch = watchEffect(
            onInvalidate => {
                console.log(
                    '这里是 pre 类型的watchEffect  this.username  ------------',
                    username
                )
                console.log(
                    '这里是   pre 类型的watchEffect  obj.foo  ------------',
                    obj.foo
                )
                sendRequest()
        ...
        function sendRequest() {
            ...
            return axios
                .get(
                    'https://dohko.m.hualala.com/orh5/qrcode/info?s=32142625_pjt5&groupID=11157',
                    {
